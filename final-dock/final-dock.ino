  ...
  stavCLK = digitalRead(pinCLK);
    if (stavCLK != stavPred) {
      if (digitalRead(pinDT) != stavCLK) {
        poziceEnkod++;
        if(poziceEnkod>90){poziceEnkod=65;}
      }else{
        poziceEnkod--;
        if(poziceEnkod<65){poziceEnkod=90;}
      }
    }
    stavPred = stavCLK;
...
stavCLK1 = digitalRead(pinCLK1);
    if (stavCLK1 != stavPred1) {
      if (digitalRead(pinDT1) != stavCLK1) {
        poziceEnkod1++;
        if(poziceEnkod1>90){poziceEnkod1=65;}
      }else{
        poziceEnkod1--;
        if(poziceEnkod1<65){poziceEnkod1=90;}
      }
    }
    stavPred1 = stavCLK1;
  ...
  stavCLK2 = digitalRead(pinCLK2);
    if (stavCLK2 != stavPred2) {
      if (digitalRead(pinDT2) != stavCLK2) {
        poziceEnkod2++;
        if(poziceEnkod2>90){poziceEnkod2=65;}
      }else{
        poziceEnkod2--;
        if(poziceEnkod2<65){poziceEnkod2=90;}
      }
    }
    stavPred2 = stavCLK2;
  ...
  stavCLK3 = digitalRead(pinCLK3);
    if (stavCLK3 != stavPred3) {
      if (digitalRead(pinDT3) != stavCLK3) {
        poziceEnkod3++;
        if(poziceEnkod3>90){poziceEnkod3=65;}
      }else{
        poziceEnkod3--;
        if(poziceEnkod3<65){poziceEnkod3=90;}
      }
    }
    stavPred3 = stavCLK3;
